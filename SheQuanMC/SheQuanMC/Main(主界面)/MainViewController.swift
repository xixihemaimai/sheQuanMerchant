...
//        UITabBarItem.appearance().setTitleTextAttributes([NSAttributedString.Key.foregroundColor : tabbarNormalColor], for: .normal)
//        UITabBarItem.appearance().setTitleTextAttributes([NSAttributedString.Key.foregroundColor : tabbarSelectColor], for: .selected)
     ...
     func creatViewController(title:String,normalString:String,selectString:String)->UIViewController{
...
//         navi.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor : tabbarSelectColor], for: .selected)
//         navi.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor : tabbarNormalColor], for: .normal)
