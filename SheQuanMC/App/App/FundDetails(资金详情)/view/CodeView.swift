...
public enum CodeContentStyle{
    case CodeContentStyle_number
    case CodeContentStyle_password
}
...
class CodeView: UIView {
    ...
    public var contentStyle:CodeContentStyle?            //输入是数字显示还是密码暗文显示
    ...
    public init(frame:CGRect,codeNumber:Int = 6,style:CodeStyle = .CodeStyle_line,contentStyle:CodeContentStyle = .CodeContentStyle_number,labelTextColor:UIColor = UIColor.black, mainColor:UIColor = UIColor.orange,normalColor:UIColor = UIColor.gray,margin:CGFloat = 12.0) {
...
//               subView.backgroundColor = UIColor.colorWithDyColorChangObject(lightColor: "#EDEDED")
...
//                   layer.borderWidth = 0.5
                   ...
                   layer.backgroundColor = UIColor.colorWithDyColorChangObject(lightColor: "#EDEDED").cgColor
                   if index == 0 {
    ...
    @objc func textChage(_ textField: UITextField) {
        ...
        for index in 0..<codeNumber {
            ...
            if (index < verStr.count){
                ...
                if contentStyle == .CodeContentStyle_number{
