...
extension BaseNaviViewController:UINavigationControllerDelegate{
   ...
   open func navigationController(_ navigationController: UINavigationController, willShow viewController: UIViewController, animated: Bool) {
       ...
       if viewController.isKind(of: StartPageViewController.self) || viewController.isKind(of: ShopViewController.self) || viewController.isKind(of: MyViewController.self) || viewController.isKind(of: CommoditySearchViewController.self){
